...
The **HX711** is a precision 24-bit analog-to-digital converter (ADC) designed for weigh scales and industrial control applications. This component bundles the HX711 amplifier with a 5kg load cell.
...
The simulation provides an interactive slider (from 0kg to 5kg) to adjust the weight. The raw ADC values range from 0 to 2100.
`;
