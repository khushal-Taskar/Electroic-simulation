...
export const HC595UI = (props: any) => {
        ...
        <div style={{
            ...
            <svg width={w} height={h} viewBox={`0 0 ${w} ${h}`} xmlns="http://www.w3.org/2000/svg">
                <g>
                    ...
                    <text x={w / 2} y={h / 2 + 12} fill="#999900" fontSize="14" fontFamily="sans-serif" fontWeight="bold" textAnchor="middle" dominantBaseline="middle">595</text>
                </g>
            </svg>
        </div>
    );
