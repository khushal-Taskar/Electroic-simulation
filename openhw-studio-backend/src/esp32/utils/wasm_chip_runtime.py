...
Loads an OpenHW Custom Chip (.wasm compiled from C against openhw-chip.h) and
...
# I2C config struct layout (must match openhw-chip.h's vx_i2c_config — 64 bytes)
...
class WasmChipRuntime:
    ...
    # Pin mode constants (mirror openhw-chip.h)
    MODE_OUTPUT_LOW = 16
    MODE_OUTPUT_HIGH = 17
    ...
    def _define_openhw(self, linker: wasmtime.Linker) -> None:
        i32 = wasmtime.ValType.i32()
        i64 = wasmtime.ValType.i64()
